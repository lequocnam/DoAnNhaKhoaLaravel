...
<form method="POST" action="{{ route('employee.lichhen.data') }}">
  @csrf
        ...
        <div class="modal-body">
          <div class="row">
            <div class="mb-3 row">
              ...
              <input name="malichhen" required type="text"  value="{{ $lastId }}"
              class="form-control">
              </div>        
              </div>
          <br>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <form method="POST" action="{{ route('employee.lichhen.update',['id' => $lichhen->getid()]) }}">
          @csrf
          @method('put')
          <div class="modal fade" id="edit{{ $lichhen->id }}" tabindex="-1">
           ...
           <form method="POST" action="{{ route('employee.lichhen.delete',['id' => $lichhen->getid()]) }}">
          @csrf
          @method('delete')
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <div class="mb-3 row">
                          <label class="col-lg-2 col-md-6 col-sm-12 col-form-label">Mã Lịch Hẹn:</label>
                          <div class="col-lg-10 col-md-6 col-sm-12">
                          <input name="malichhen" type="text" readonly value="{{$lichhen->getmalichhen()}}"
                          class="form-control">
                          </div>        
                          </div>
                      <br>
                      <div class="mb-3 row">
                        <label class="col-lg-2 col-md-6 col-sm-12 col-form-label">Tên Khách Hàng:</label>
                        <div class="col-lg-10 col-md-6 col-sm-12">
                        <input name="ten" type="text" readonly value="{{$lichhen->getten()}}"
                        class="form-control">
                        </div>
                        </div>
                        <br>
                        <form>
                          <div class="mb-3 row">
                            <label class="col-lg-2 col-md-6 col-sm-12 col-form-label">Giới Tính:</label>
                            <div class="col-lg-10 col-md-6 col-sm-12">
                              <input type="radio" disabled name="gioitinh" {{ $lichhen->getgioitinh() === 'Nam' ? 'checked' : '' }}>Nam
                            <input type="radio" disabled name="gioitinh" {{ $lichhen->getgioitinh() === 'Nữ' ? 'checked' : '' }}>Nữ
                            </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                              <label class="col-lg-2 col-md-6 col-sm-12 col-form-label">Số Điện Thoại:</label>
                              <div class="col-lg-10 col-md-6 col-sm-12">
                              <input name="sodienthoai" readonly type="text" value="{{$lichhen->getsodienthoai()}}"
                              class="form-control">
                              </div>
                              </div>       
                              <br>
                            <div class="mb-3 row">
                              <label class="col-lg-2 col-md-6 col-sm-12 col-form-label">Địa Chỉ:</label>
                              <div class="col-lg-10 col-md-6 col-sm-12">
                              <input name="diachi" type="text" readonly value="{{$lichhen->getdiachi()}}"
                              class="form-control">
                              </div>
                              </div>  
                              <br>
                              <div class="mb-3 row">
                                <label class="col-lg-2 col-md-6 col-sm-12 col-form-label">Nội Dung Khám:</label>
                                <div class="col-lg-10 col-md-6 col-sm-12">
                                <input name="noidungkham" readonly type="text" value="{{$lichhen->getnoidungkham()}}"
                                class="form-control">
                                </div>
                                </div> 
                                <br>                                        
                          <div class="mb-3 row">
                            <label class="col-lg-2 col-md-6 col-sm-12 col-form-label">Ngày Hẹn:</label>
                            <div class="col-lg-10 col-md-6 col-sm-12">
                            <input name="ngayhen" readonly type="date" value="{{$lichhen->getngayhen()}}"
                            class="form-control">
                            </div>
                            </div> 
                            <br>
                            <div class="mb-3 row">
                              <label class="col-lg-2 col-md-6 col-sm-12 col-form-label">Ngày Dự Kiến:</label>
                              <div class="col-lg-10 col-md-6 col-sm-12">
                              <input name="ngaydukien" readonly type="date" value="{{$lichhen->getngaydukien()}}"
                              class="form-control">
                              </div>
                              </div> 
                            <br>
                            <div class="mb-3 row">
                              <label class="col-lg-2 col-md-6 col-sm-12 col-form-label">Trạng Thái:</label>
                              <div class="col-lg-10 col-md-6 col-sm-12">
                              <input name="trangthai" type="text" readonly value="{{$lichhen->gettrangthai()}}"
                              class="form-control">
                              </div>
                              </div>          
                    </div>
